...
if(isset($_POST['readrecords'])){
	...
	$displayquery = " SELECT * FROM hospital"; 
...
if(isset($_POST['place_name'])  )
   ...
   $query  = "Insert into hospital (place_name,hospital_name,address,contact_no) VALUES ('$place_name','$hospital_name','$address','$contact_no')";
...
{
    $user_id = $_POST['id'];
    $query = "SELECT * FROM hospital_jayed WHERE id = '$user_id'";
    if (!$result = mysqli_query($conn,$query)) {
        exit(mysqli_error());
    }
...
if(isset($_POST['deleteid']))
{
	...
	$deletequery = " delete from hospital where id ='$user_id' ";
