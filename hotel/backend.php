...
if(isset($_POST['district'])  )
   ...
   $query  = "Insert into place (district,place_category,place_name,travel_path,place_des,place_image) VALUES ('$district','$view','$place_name','$travel_path','$place_description','$dst')";
...
{
    $user_id = $_POST['id'];
    $query = "SELECT * FROM place WHERE id = '$user_id'";
    if (!$result = mysqli_query($conn,$query)) {
        exit(mysqli_error());
    }
