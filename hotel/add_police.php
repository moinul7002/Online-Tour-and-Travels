...
?>
        ...
        <div class="form-group">
          <label>   Name </label>
          <input type="text" name="police_station_name" id="police_station_name"  placeholder="police_station Name" class="form-control">
        </div>
         ...
         <div class="form-group">
          <label> Address </label>
          <input type="text" name="police_station_address" id="police_station_address"  placeholder="police_station Address" class="form-control">
        </div>


        <div class="form-group">
          <label> Contact </label>
          <input type="text" name="police_station_contact" id="police_station_contact"  placeholder="police_station_contact" class="form-control">
        </div>
...
$(document).ready(function () {
  ...
  function addRecord(){
    ...
    var police_station_contact =  $("#police_station_contact").val();
...
var formData= new FormData();
 ...
 formData.append("place_name",place_name);
  formData.append("police_station_name", police_station_name);
 
    formData.append("address", police_station_address);
     formData.append("contact_no", police_station_contact);
...
function DeleteUser(deleteid){
  ...
  if(conf == true) {
  $.ajax({
    url:"backend_police_station.php",
    type:'POST',
...
function GetUserDetails(id){
    ...
    $.post("backend_police_station.php", {
            id: id
        },
...
function UpdateUserDetails() {
  ...
  <script src="js/js-grid-police_station.js"></script>
