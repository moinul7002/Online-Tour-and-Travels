...
$sql="Select * from res where id=$res_id";
...
if(isset($_POST['review_submit']))
{
	...
	$sql_gallery2="Insert into res_gallery(res_name,image) VALUES('$res_name','$dst')";
	...
	$sql2="INSERT INTO res_review(res_id,user_id,review,rating,image) VALUES ($res_id,$user_id,'$review',$rating,'$dst') ";
	$res2=mysqli_query($conn,$sql2);
	if($res2)
	{
		header("location:res_review.php?id=$res_id"); 
	}
}
...
$sql_gallery="Select * from res_gallery where res_name='$res_name'";
...
<section class="page-title-banner" style="background-image:url(<?php echo $row['res_image'] ?>);">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				<div class="tab" role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" ><a href="res_detail.php?id=<?php echo $res_id?>" ><i class="ti-user"></i>Overview</a></li>

						<li role="presentation" class="active" ><a href="res_review.php?id=<?php echo $res_id?>" >Review</a></li>
