...
$sql3="Select * from res_review where res_id=$id";
			...
			<div class="col-md-12 col-sm-12">
				<div class="tab" role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active" ><a href="res_detail.php?id=<?php echo $id?>" ><i class="ti-user"></i>Overview</a></li>
						
						<li role="presentation"><a href='res_review.php?id=<?php echo $row['id']?>' >Review</a></li>
